...
class CashierShop extends Component {
	...
	render() {
		...
		return (
			<>
				...
				<Modal show={this.state.addToCart} size="lg" aria-labelledby="contained-modal-title-vcenter" centered >
					<Modal.Header>
													...
													this.state.scheduleLoading ?
														<div className="sweet-loading mr-3">
															<ClipLoader css={override} size={30}
																color={"#3C96B3"} loading={this.state.scheduleLoading} />
														</div>
													:
...
export default connect(mapStateToProps, mapDispatchToProps)(CashierShop);