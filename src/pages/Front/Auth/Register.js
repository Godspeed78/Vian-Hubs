...
import {getAccountID, handleAxiosError, handleFormSubmissionError, loginUser} from "../../../utils/helpers";
                        ...
                        <div className="col-md-6">
                            <div className="card border-0 box-shadow">
                                <div className="card-body">
                                    ...
                                    <p className="font-size-sm text-muted mb-4">Registration takes less than a minute but
                                    ...
                                    <form className="needs-validation" noValidate onSubmit={this.register}>
                                        <div className="row">
                                            ...
                                            <div className="col-sm-6">
                                                <div className="form-group">
                                                    ...
                                                    <input className="form-control" onChange={this.changeText} onKeyUp={this.comparePassword}
                                            ...
                                            <div className="col-sm-6">
                                                <div className="form-group">
                                                    ...
                                                    <input className="form-control" onChange={this.changeText} onKeyUp={this.comparePassword}
                                                           name='password_confirm' type="password" required id="reg-password-confirm"/>
                                                    {this.state.passCorrect === 'unequal' ?
                                                        <div className="small text-danger my-2"><i className="czi-close-circle mr-2"/> Passwords do not match!</div>
                                                    : null
                                                    }
                                                    {this.state.passCorrect === 'equal' ?
                                                        <div className="small text-success my-2"><i className="czi-check-circle mr-2"/>Passwords match!</div>
                                                    : null
                                                    }
                                                </div>
                                            </div>
                                        ...
                                        <div className="custom-control custom-checkbox">
                                            <input className="custom-control-input" onChange={this.changeText}
                                                   name='terms' type="checkbox" checked id="remember_me"/>
