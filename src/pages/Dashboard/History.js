												...
												this.state.sessions.map( (session, index) => {
													return (
														<tr>
															...
															<td>{formatNaira(session.service.cost)}</td>
															<td>
																<button className="btn btn-sm btn-accent btn-primary"
				...
				>
					...
					<Modal.Body>
						...
						<form action="">
							<div className="form-group">
								...
								<input name="reviewComment" type="text" onChange={this.changeText} className="form-control"/>
							</div>
					...
					<Modal.Footer>
						{this.state.reviewLoader ?
							...
							:
							<button className="btn btn-custom" onClick={() => this.reviewOrder()}>
								<i className="czi-star mr-2"/>
								Submit
							</button>
						}

						<button className="btn btn-outline-danger" onClick={()=> this.toggleReviewModal()}>Close</button>
					</Modal.Footer>
				</Modal>
