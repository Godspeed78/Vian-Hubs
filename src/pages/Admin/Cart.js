...
import {currencyFormat, formatNaira, time_convert} from "../../utils/helpers";
		...
		return (
			<>
				<div className="border-bottom mt-lg-2 mt-5 pt-5 pb-2 mb-2">
					...
					<h2 className="mt-lg-1 pt-lg-1">Order Cart</h2>
				</div>
															...
															this.state.cart.map((item, index) => {
																return (
																	<div className="media d-block d-sm-flex align-items-center py-4 border-bottom">
																		<p className="d-block position-relative mb-3 mb-sm-0 mr-sm-4 mx-auto"
																		   style={{width: '12.5rem'}}>
																		...
																		<div className="media-body text-center text-sm-left">
																			...
																			<div className="d-inline-block mt-3 mr-2 pr-2">
																				<small className='font-weight-bold'>
																					{/*{new Date(item.start_at).toDateString()}*/}
