...
class CustomerReviews extends Component {
  ...
  getCustomerReviews = () => {
    ...
    .then((res) => {
      this.setState({ customerReviews: res.data.data.data });
      console.log(this.state.customerReviews, "Customers Reviews");
    });
  };
                            ...
                            this.state.customerReviews.map((a, b) => {
                              return (
                                <tr>
                                  ...
                                  <td>
                                 <button className="btn btn-outline-primary btn-sm" onClick={() => this.loadReviewData(a)}>
                                      <i className="czi-eye" />
                                  </button>
                                    &nbsp;
                                    <button
